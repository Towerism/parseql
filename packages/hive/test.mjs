...
test("option: allowMultiStatement true - successful parse", (t) => {
  parse(examplesMap["multi-statement.hql"], { allowMultiStatement: true });
  t.pass();
});

test("option: allowMultiStatement false - successful parse", (t) => {
  parse(examplesMap["single-statement.hql"], { allowMultiStatement: false });
  t.pass();
});

test("option: allowMultiStatement false - failed parse", (t) => {
  t.throws(() => parse(examplesMap["multi-statement.hql"], { allowMultiStatement: false }));
});
